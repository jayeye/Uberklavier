 ...
 */
#ifndef __DSJIKeyboard_h__
#define __DSJIKeyboard_h__
...
class DSJIKeyboardDevice : public Print {
 public:
  DSJIKeyboardDevice () {
    cli();
    usbDeviceDisconnect();
...
DSJIKeyboardDevice DSJIKeyboard = DSJIKeyboardDevice();
